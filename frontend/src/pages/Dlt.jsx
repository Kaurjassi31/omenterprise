  ...
  return (
    ...
    <div className="container-fluid mb-5">
        ...
        >
          ...
          <p>
 is a digital system for keeping and managing the record of sender IDs and template.<b>TRAI has introduced an advanced extension of the Blockchain – Distributed Ledger Technology (DLT) to prevent spam

Guidelines for Distributed Ledger Technology (DLT) for Enterprises</b>
...
You can go to below Operator DLT Registration portals:</p>
<a href='https://smartping.live/entity/reg-as '>
    https://smartping.live/entity/reg-as (Videocon DLT URL) Om Enterprises TM ID : 1702157769397119438
</a>
<p className='mt-4'>
