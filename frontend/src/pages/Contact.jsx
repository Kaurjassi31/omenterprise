      ...
      <div className="container-fluid text-center mt-5 mb-5">
        ...
        <div class="row row-cols-1 row-cols-md-4 g-4">
          <div class="col">
            <div class="card">
              <center>
              <img src={office} class="card-img-top mt-3" style={{height:"60px",width:"60px"}} alt="..." />
              </center>
              <div class="card-body">
                <h4 class="card-title">Head Office </h4>
                <h6 class="card-text">
                  770, Mota Singh Nagar , Near Bus <br/> Stand, Jalandhar -144001{" "}
                </h6>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card">
            <center>
              <img src={ms} class="card-img-top mt-3" style={{height:"60px",width:"60px"}} alt="..." />
              </center>
              <div class="card-body">
          ...
          <div class="col">
            <div class="card">
            <center>
              <img src={query} class="card-img-top mt-3" style={{height:"60px",width:"60px"}} alt="..." />
              </center>
              <div class="card-body">
                <h4 class="card-title">For All Queries</h4>
                <h6 class="card-text">
                info@omenterprisesgroup.in,<br/>
          ...
          <div class="col">
            <div class="card">
            <center>
              <img src={care} class="card-img-top mt-3" style={{height:"60px",width:"60px"}} alt="..." />
              </center>
              <div class="card-body">
